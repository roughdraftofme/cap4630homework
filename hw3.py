...
Original file is located at
    https://colab.research.google.com/drive/1gWkDCFtMMAoXv2AioOMAjjf-0yx4MgNz
...
!cp "/content/gdrive/My Drive/RuTanks7000_v2.zip" /content/HW3/datasets
!unzip -q /content/HW3/datasets/RuTanks7000_v2.zip -d /content/HW3/datasets
print("Number of Training Images Unzipped:")
!ls -laR /content/HW3/datasets/RuTanks7000/train | grep -i jpg | wc -l
print("Number of Testing Images Unzipped:")
!ls -laR /content/HW3/datasets/RuTanks7000/test | grep -i jpg | wc -l
print("Subdirectories (Image Classes):")
!ls /content/HW3/datasets/RuTanks7000/train
...
# path settings
path = '/content/HW3/'
dataset_path = path+'datasets/RuTanks7000/'
